...
waarden uit het domein *RolExternPlan_BP*:  
    ...
    plan ", als uiteengezet in [Hoofdstuk 4](#H04) van deze praktijkrichtlijn.
<br/><br/>
...
Een nadere toelichting op de werkwijze is gegeven in [Hoofdstuk 4](#H04) van deze
praktijkrichtlijn.
<br/><br/>
...
[Hoofdstuk 4](#H04) van deze praktijkrichtlijn.
<br/><br/>
...
**naam** (verplicht):  
De werkwijze om te komen tot de naam van een functieaanduiding is bepaald in de <a href='https://docs.geostandaarden.nl/ro/svbp/#45B24E21' target='_blank'>SVBP2012, paragraaf 5.3</a>. De waarde van het attribuut *naam* kan door de bronhouder gekozen
worden uit de lijst van functies die is opgenomen als bijlage van de SVBP2012.  

In het geval de gewenste functie niet in de <a href='https://docs.geostandaarden.nl/ro/SVBPfunctielijst/' target='_blank'>SVBP 2012 functielijst</a> voorkomt, is de naam
